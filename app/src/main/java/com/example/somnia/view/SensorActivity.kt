...
import com.example.somnia.BuildConfig
import com.example.somnia.R
import com.google.android.gms.auth.api.signin.GoogleSignIn
import com.example.somnia.common.*
import com.example.somnia.common.Log.setLogNode
    ...
    private fun requestRuntimePermissions(requestCode: FitActionRequestCode) {
        ...
        requestCode.let {
            if (shouldProvideRationale) {
                ...
                Snackbar.make(
                    findViewById(R.id.sensor_activity_view),
